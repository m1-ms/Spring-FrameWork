...
import entity.inheritance.AdminUser;
import entity.inheritance.RegularUser;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Configuration configuration = new Configuration().addAnnotatedClass(User.class).addAnnotatedClass(UserDetails.class)
                ...
                .addAnnotatedClass(AdminUser.class).addAnnotatedClass(RegularUser.class)
        ...
        */
        ...
        // Inheritance Test - AdminUser & RegularUser
        AdminUser admin = new AdminUser("Youssef Admin", 35, "SUPER_ADMIN");
        RegularUser regular = new RegularUser("Nadia", 28, "PREMIUM");
